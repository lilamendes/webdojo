describe('Formulário de Consultoria', () => {
    ...
    it.only('Deve solicitar consultoria individual', () => {
        ...
        //input type="file"
        //svg > tag geralmente usada para inserir ícone / imagem ou logotip
        ...
        //como cypress reclamou q o elemento da tag estava com classe p deixar ele invisível e por isso n encontrava ele, usei o comando para forçar: { force: true }

        cy.get('input[type="file"]') //precisei arrastar a imagem para dentro da pasta fixtures de dentro desse meu projeto
            .selectFile('./cypress/fixtures/document.pdf', { force: true }) //inseri o nome do arquivo que arrastei para dentro da pasta fixtures do projeto


        //area de texto/ text area***************************************************************************************************************************************
        // site atoa para gerar pdf: https://loremipsum.io/
        cy.get('textarea[placeholder="Descreva mais detalhes sobre sua necessidade"]')
            .type('Lorem ipsum dolor sit amet. Duis nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit laborum.')
        ...
        cy.get('.modal', { timeout: 70000 })//buscando elementos por classes. {timeout:70000} > comando de tempo pq estava demorando p achar essa classe
            .should('be.visible')
            .find('.modal-content p') //peguei essa classe que estava em um elemento dentro da classe da linha de cima, e peguei o elemento <p>, mas n tem necessidade do p pq tem um só
            .should('be.visible')
    ...
    it('Deve verificar os campos obrigatórios', () => {
        ...
        cy.contains('button', 'Enviar formulário') // estou validando os campos obrigatórios, por isso cliquei diretamente no botão 'Enviar formulário'
            .click()

        cy.contains('label', 'Nome Completo *') //validando a mensagem de erro que aparece, informando o que deve ser preenchido no campo
            .parent()
            .find('p')
            .should('be.visible')
            .should('have.text', 'Campo obrigatório')
            .and('have.class', 'text-red-400')
            .and('have.css', 'color', 'rgb(248, 113, 113)') //site com cores rgb https://htmlcolorcodes.com/
        ...
        cy.contains('label', 'termos de uso')   //daria para ir direto no 'p','Você precisa aceitar os termos de uso'
            .parent()
            .find('p')
            .should('be.visible')
